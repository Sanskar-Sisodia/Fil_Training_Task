...
public class DB_Reg4 {
    ...
    public static void registerUser(Scanner sc,DbConn db) {
        try {
            ...
            String checkQuery = "SELECT email, mobile FROM table2 WHERE email = ? OR mobile = ?";         // Check if email or mobile already exists
            ...
            // Insert new user
            String insertQuery = "INSERT INTO table2 VALUES (?, ?, ?, ?, ?)";
    ...
    public static void updateUser(Scanner sc,DbConn db) {
        try {
            ...
            // Update user details
            String updateQuery = "UPDATE table2 SET name = ?, password = ?, email = ?, mobile = ? WHERE e_id = ?";
    ...
    public static void deleteUser(Scanner sc, DbConn db) {
        try {
            ...
            // Delete user
            String deleteQuery = "DELETE FROM table2 WHERE e_id = ?";
